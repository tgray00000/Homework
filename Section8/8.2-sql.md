...
- For the purpose of this exercise, if the car's `RapidCharge` value equals (%charging possible) then I want you to change the value to 'Yes' 
- If the `RapidCharge` value equals (% not possible) then I want you to change the value to 'No'.
<br>
...
- If the PowerTrain equals _All%_______ then I want you to change the value to 'AWD'
- If the PowerTrain equals __Rear%________ then I want you to change the value to 'RWD'
- If the PowerTrain equals___Front%____ then I want you to change the value to 'FWD'
<br>
